...
export const SIX_STAR_OPERATOR_PROFILES: OperatorProfile[] = [
  ...
  { name: "琴柳", rarity: 6, deployType: "melee", damageType: "physical", roleHints: ["vanguard", "support"], functions: ["early_dp", "buff", "debuff", "control"] },
  ...
  { name: "泥岩", rarity: 6, deployType: "melee", damageType: "physical", roleHints: ["tank", "guard"], functions: ["main_tank", "lane_holder", "sustained_dps"] },
  ...
  { name: "假日威龙陈", rarity: 6, deployType: "ranged", damageType: "physical", roleHints: ["sniper"], functions: ["physical_burst", "boss_killer", "aoe_clear"] },
  ...
  { name: "鸿雪", rarity: 6, deployType: "ranged", damageType: "physical", roleHints: ["sniper"], functions: ["physical_burst", "boss_killer", "debuff"] },
  ...
  { name: "刻俄柏", rarity: 6, deployType: "ranged", damageType: "arts", roleHints: ["caster"], functions: ["arts_dps", "boss_killer"] },

  { name: "纯烬艾雅法拉", rarity: 6, deployType: "ranged", roleHints: ["medic"], functions: ["healer", "buff"] },
  ...
  { name: "流明", rarity: 6, deployType: "ranged", roleHints: ["medic"], functions: ["healer", "special_mechanic"] },
  ...
  { name: "浊心斯卡蒂", rarity: 6, deployType: "ranged", roleHints: ["support", "medic"], functions: ["buff", "healer", "summon"] },
  { name: "灵知", rarity: 6, deployType: "ranged", damageType: "arts", roleHints: ["support"], functions: ["control", "debuff", "buff"] },
